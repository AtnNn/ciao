...
%% It is generated by library/Makefile, in the "autolibs" goal.

:- include(library('persdb_mysql/linker_opts')).
...
:- comment(version(1*7+209,2002/04/24,14:50*46+'CEST'), "Added
   ...
   Makefile, the linker_opts.pl which is used by the system in order
   to locate the MySQL library.  (MCL)").
