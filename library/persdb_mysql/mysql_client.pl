:- module(mysql_client,
	[
	    ...
	    mysql_table_types/3,
	    mysql_disconnect/1
	],[assertions,regtypes,basicmodes,functions,foreign_interface]).
...
:- comment(module,"This library provides a low-level interface to MySQL
...
:- comment(version(1*7+105,2001/05/28,11:16*19+'CEST'), "extra linker
   option '-framework Zip' changed to '-lz' (JCF) (Jesus Correas
   Fernandez)").

:- comment(version(1*7+88,2001/04/09,16:22*12+'CEST'), "Added
   -framework System for Mac OS X (MCL)").
