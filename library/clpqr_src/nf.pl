:- module(nf,
        [normalize/2,normalize/3,normalize/4,normalize/5,
         nf_coeff_of/3,mult_linear_factor/3,delete_factor_ordered/4,
         nf_substitute/7,nf_order/2,
         add_linear_ff/5,add_linear_1f/4,add_linear_11/3,add_f_log/5,
         factor/3,factor_k/4,factor_kk/6],
        [.(clp_src)]).
%
