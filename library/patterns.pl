...
:- comment(version(0*8+40,1999/03/01,19:54*28+'MET'), "pattern/1 type
   exported for usage in librowser (Angel Fernandez Pineda)").

:- comment(version(0*8+35,1999/02/23,20:17*47+'MET'), "Updated comments to
   new format and documentation.  (Angel Fernandez Pineda)").
