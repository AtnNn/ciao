...
:- comment(sybasetype/1,"SQL datatypes supported by Sybase for which a
...
:- comment(postgrestype/1,"SQL datatypes supported by postgreSQL for which a
   translation is defined:
...
:- comment(version(1*7+127,2001/10/26,14:52*05+'CEST'), "Moved to a
separate directory (MCL)").

:- comment(version(1*3+19,1999/07/06,12:21*10+'MEST'), "Minor changes
   to comments.  (Manuel Hermenegildo)").

:- comment(version(0*9+95,1999/05/21,19:44*46+'MEST'), "Extracted type
   system from persdb_sql/pl2sql library (Ignacio Caballero Blanco)").
% -----------------------------------------------------------------------------
