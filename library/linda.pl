...
:- comment(version(0*9+66,1999/04/29,12:28*00+'MEST'), "Uncommented
use of fastrw library (MCL)").

:- comment(version(0*9+65,1999/04/29,12:27*20+'MEST'), "Changed
from_linda/2 to from_linda_code/2 (MCL)").
