...
:- comment(title,"Getting started on Windows machines").
...
@cindex{running programs}
      ...
      @em{Ciao Prolog scripts}, will also execute them. These are
      files containing Prolog source but which get executed without
