...
:- load_compilation_module(library(tabling('ResumingBeforeCheck'(tabling_tr_PADL)))).

:- add_sentence_trans(do_term_expansion/3).

:- use_module(library(tabling('ResumingBeforeCheck'(tabling_rt_PADL)))).
