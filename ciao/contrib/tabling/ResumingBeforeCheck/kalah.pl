...
:- table /(alphabeta,6).
:- table /(announce,1).
:- table /(checkcapture,7).
:- table /(checkiffinished,2).
:- table /(choosemove,3).
:- table /(cutoff,9).
:- table /(displaygame,2).
:- table /(displayholes,1).
:- table /(distribute,3).
:- table /(distributemyholes,5).
:- table /(distributestones,4).
:- table /(distributeyourholes,3).
:- table /(evaluateandchoose,7).
:- table /(extendmove,4).
:- table /(gameover,3).
:- table /(genlegal,1).
:- table /(initialize,3).
...
:- table /(nsubstitute,4).
:- table /(nthmember,3).
:- table /(pickupanddistribute,4).
:- table /(pieces,1).
:- table /(play,3).
:- table /(rev,3).
:- table /(show,1).
:- table /(stonesinhole,3).
:- table /(sumlist,2).
:- table /(sumlist,3).
:- table /(swap,2).
:- table /(unify_sets,2).
...
test2 :- write(sumlist__1(_64,_66,_68)), nl, fail.
test2.

test :- tp, fail.
test :- write('=========== Result is ================'), nl, show_facts.
...
show_facts2 :- sumlist__1(_63,_65,_67),
              numbervars([_63,_65,_67]),
...
set_unify(A,B) :-
	display('llamada a set instanciada a '), display(set(A,B)), nl	
