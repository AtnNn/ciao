...
:- load_compilation_module(library(tabling('SimulatedCHAT'(tabling_tr_CHAT)))).

:- add_sentence_trans(do_term_expansion/3).

:- use_module(library(tabling('SimulatedCHAT'(tabling_rt_CHAT)))).
...
:- doc(goal/1,"Defines a Prolog goal to be called which is
   generated by @pred{tabled_call/4} primitive. ").
