...
#define TrNode_arity(X)     ((X)->arity)
#define TrNode_name(X)      ((X)->name)
...
#define AS_TR_NODE_NEXT(ADDRESS) (TrNode)((int)(ADDRESS) - sizeof(tagged_t) - 2 * sizeof(trie_node_t *))
#define AS_TR_HASH_NEXT(ADDRESS) (TrHash)((int)(ADDRESS) - sizeof(tagged_t) - 2 * sizeof(int) - sizeof(trie_node_t **))
...
#define IsTrieVar(TERM)  (((TERM) & 0xF0000000) == 0x60000000 )
#define MkTrieVar(INDEX)          ((INDEX))
#define TrieVarIndex(TERM)        ((TERM) >> 2)
