...
:- comment(version(1*5+91,2000/03/24,17:18*52+'CET'), "Corrected the
   ...
   other documentation mods.  (Manuel Hermenegildo)").

:- comment(version(1*5+87,2000/03/24,12:37*02+'CET'), "Added some
   minor mods to the documentation.  (Manuel Hermenegildo)").

:- comment(version(1*5+82,2000/03/23,18:27*00+'CET'), "Minor modifications
   on ciaoc.pl source code (elimination of some redundant code).  (Oscar
   Portela Arjona)").

:- comment(version(0*9+103,1999/05/30,19:14*54+'MEST'), "Improved
