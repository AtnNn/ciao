...
builtin_export(basic_props,sideff,2,sideff(goal,?)) .
...
builtin_export(basiccontrol,\+,1,\+(goal)) .
...
builtin_export(io_basic,skip_line,1,0) .
builtin_export(io_basic,skip_line,0,0) .
