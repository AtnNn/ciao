...
builtin_export(concurrency,eng_cut,1,0) .
builtin_export(concurrency,eng_release,1,0) .
builtin_export(concurrency,eng_wait,1,0) .
builtin_export(concurrency,eng_kill,1,0) .
