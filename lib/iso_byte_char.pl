...
:- comment(char_code(Char,Code), "Succeeds iif the character code of
...
:- comment(peek_byte(Stream, Byte), "Is true iif @var{Byte} unifies
   with the next byte to be input from the target @var{Stream}.").
...
:- comment(version(1*9+217,2003/12/21,15:33*54+'CET'), "Minor mods to
   doc.  (Manuel Hermenegildo)").

:- comment(version(1*9+202,2003/12/20,14:23*25+'CET'), "Added
   documentation based on ISO Prolog standard. (Edison Mera)").
