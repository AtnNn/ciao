...
:- comment(title,"All solutions predicates").

:- comment(author,"First version by Richard A. O'Keefe and David
   H.D. Warren. Changes by Mats Carlsson, Daniel Cabeza, and Manuel
   Hermenegildo").

:- comment(module,"This module implements the standard solution
...
:- comment(version(0*1+0,1987/1/1), "Adapted from shared code written by
   Richard A. O'Keefe.").

:- comment(version(0*0+0,1982/1/1), "Original code written by Richard
   A. O'Keefe and David H.D. Warren.").
