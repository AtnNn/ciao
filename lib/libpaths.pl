...
:- comment(library_directory/1, "See @ref{Basic file/stream handling}.").
:- comment(file_search_path/2, "See @ref{Basic file/stream handling}.").

:- multifile file_search_path/2, library_directory/1.
:- dynamic file_search_path/2, library_directory/1.

:- comment(get_alias_path, "Consult the environment variable
