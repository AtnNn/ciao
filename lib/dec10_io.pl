...
:- comment(title,"DEC-10 Prolog file IO").

:- comment(module,"This module implements the support for DEC-10
...
:- comment(version(1*9+273,2004/01/05,20:14*41+'CET'), "Taken out
   importation of library(streams).  (Daniel Cabeza Gras)").

:- comment(version(0*4+5,1998/2/24), "Synchronized file versions with
   global CIAO version.  (Manuel Hermenegildo)").

:- comment(version(0*3+1,1998/1/9), "Fixed paths for used modules
   (engine/library). (Manuel Hermenegildo)").

:- comment(version(0*3+0,1998/1/9), "Started in-code
