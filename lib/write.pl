...
:- comment(version(0*5+49,1998/07/14,20:03*29+'MET DST'), "Fixed bug when
   ...
   double quote or backslash.  (Daniel Cabeza Gras)").

:- comment(version(0*4+5,1998/2/24), "Synchronized file versions with
   global CIAO version.  (Manuel Hermenegildo)").

:- comment(version(0*1+6,1998/2/12), "Avoided all multiple arity
   warnings (Daniel Cabeza Gras)").

:- comment(version(0*1+5,1998/1/19), "Fixed bug in treatment of $VAR.
   (Manuel Hermenegildo)").

:- comment(version(0*1+4,1997/12/23), "Added printing of character
   strings within $VAR. (Manuel Hermenegildo)").

:- comment(version(0*1+3,1997/12/19), "Added writelist1/1. (Manuel
   Hermenegildo)").

:- comment(version(0*1+2,1997/8/22), "Added comments and types.
   (Daniel Cabeza)").

:- comment(version(0*1+1,1997/8/22), "Added ISO predicates
   @tt{write_term/2-3}. (Daniel Cabeza)").
