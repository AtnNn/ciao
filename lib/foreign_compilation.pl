...
:- comment(version(1*3+36,1999/07/20,10:37*31+'MEST'), "Options now
   returned as a list of atoms; an empty list denotes no options.  (Jose
   Morales)").

:- comment(version(0*9+75,1999/04/30,16:36*02+'MEST'), "Ciao Prolog
file with options generated automatically.  Comments added.  Seems to
work.  (MCL)").

:- comment(version(0*9+74,1999/04/30,13:33*04+'MEST'), "Started.
(MCL)").
