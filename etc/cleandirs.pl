...
:- comment(module,"A simple program for traversing a directory tree
...
:- comment(bug, "Recursive removal of subdirectories relies on the
...
:- comment(version(0*1+1,2000/06/01,14:43*25+'CEST'), "Permissions in
files or directories handled a little bit more gracefully.  (MCL)").

:- comment(version(0*1+0,2000/06/01,14:14*45+'CEST'), "Program entered
in Ciao distribution.  (MCL)").
