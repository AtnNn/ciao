...
:- comment(title,"Finding differences between two Prolog files").

:- comment(author,"Francisco Bueno").

:- comment(module,"This simple program works like the good old diff but for
...
:- comment(bug,"Currently uses variant/2 to compare clauses. This is useful,
