...
:- comment(version(1*0+6,1998/11/05,13:56*58+'MET'), "Fixed usage
   string.  (Manuel Hermenegildo)").

:- comment(version(1*0+5,1998/11/05,13:52*26+'MET'), "Fixed bug in
   call to atom_chars.  (Manuel Hermenegildo)").

:- comment(version(1*0+4,1998/3/11), "Added options -u and -h.
   (Francisco Bueno Carrillo)").

:- comment(version(1*0+3,1998/2/12), "Major rewrite (or, should we
   say, erase) calling the @lib{c_itf} library directly. (Manuel
   Hermenegildo)").

:- comment(version(1*0+2,1998/1/15), "Library directories can be
   specified now via additional arguments. (Manuel Hermenegildo)").

:- comment(version(1*0+1,1998/1/15), "Added documentation. (Manuel
   Hermenegildo)").

:- comment(version(1*0+0,1997/11/8), "First version. (Daniel Cabeza)").
