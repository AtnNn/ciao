...
:- comment(barchart3(Header,BarchartTitle,XTitle,XVector,YTitle,
	YVector,Footer),
...
:- comment(percentbarchart3(Header,BTitle,XTitle,XVector,YTitle,
        YVector,Footer),
...
:- comment(doinclude,xbarelement3/1).
...
:- comment(xbarelement3/1,"@includedef{xbarelement3/1}
...
:- comment(version(1*11+146,2004/01/01,14:09*17+'CET'), "Added comment
   title.  (Edison Mera)").
