...
:- comment(tablewidget2(Title,Header,ElementTable,Footer),"Shows a regular
...
:- comment(tablewidget2(Title,Header,ElementTable,Footer,BackgroundImage),
...
:- comment(version(1*9+167,2003/12/04,17:39*48+'CET'), "Added author
info (Manuel Carro)").
