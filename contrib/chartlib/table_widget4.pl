...
:- comment(tablewidget4(Title,Header,ElementTable,Footer),"Shows a regular
...
:- comment(tablewidget4(Title,Header,ElementTable,Footer,BackgroundImage),
...
:- comment(version(1*9+169,2003/12/04,17:39*54+'CET'), "Added author
info (Manuel Carro)").
