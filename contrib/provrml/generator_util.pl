...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred reading(+Entrance,+ParseIn,-ParseOut)
:: atm * parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred open_node(+ParseIn,-ParseOut,-NodeGutsParseStruct,-NodeNameId)
:: parse * parse * parse * atm
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred close_node(+ParseNodeStruct,+ParseIn,-ParseOut)
:: parse * parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred close_nodeGut(+ParseIn,-ParseOut)
:: parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred open_PROTO(+Parse,-ProtoParse)
:: parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred start_vrmlScene(+Parse,-ParseScene)
:: parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred close_PROTO(?DeclParse,+SceneParse,+ParseIn,-ParseOut)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred open_EXTERNPROTO(+Parse,-DeclParse,-StringParse)
:: parse * parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred close_EXTERNPROTO(?ParseDeclIn,?ParseStringIn,+ParseIn,-ParseOut) 
:: parse * parse * parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred open_DEF(+ParseIn,-ParseOut,-ParseNode)
:: parse * parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred close_DEF(+ParseNode,+ParseIn,-ParseOut)
:: parse * parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred open_Script(+ParseIn,-ParseOut,-ScriptParse)
:: parse * parse * parse
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- pred close_Script(+ScriptParse,+ParseIn,-ParseOut)
:: parse * parse * parse
