...
;; 
(setq load-path (cons "/home/clip/Systems/ciao-1.5/emacs-mode" load-path))
...
;; 
;; setenv INFOPATH /usr/local/info:/usr/info:/home/clip/Systems/ciao-1.5/doc/reference
;; ------------------------------------------------------------------------
;; Specific to Windows installation:
;; Location of Ciao shell
(setq ciao-system (convert-standard-filename 
      "/home/clip/Systems/ciao-1.5/shell/ciaosh.bat"))
;; Location of info manuals
(setq Info-default-directory-list  (cons 
      "/home/clip/Systems/ciao-1.5/doc/reference" 
