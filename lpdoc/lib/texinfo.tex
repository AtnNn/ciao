...
% along with this texinfo.tex file; see the file GPL.  If not, write
...
%%%% Hard to make work --implemented as macro in source (MH)
...
\def\openindices{%
%
% NOTE: Commented to allow us define our own indices. We cannot waste
% them since TeX/texinfo only allows a limited number of them.
% 'fn' index was necessary to include predicates in the table of context
%
% --Jose F. Morales
%  \newindex{cp}%
  \newcodeindex{fn}%
