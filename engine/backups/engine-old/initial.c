...
static void initialize_intrinsics()
{
  ...
  define_c_mod_predicate("internals","$atom_mode",prolog_atom_mode,2);
  define_c_mod_predicate("system_info","ciaolibdir",prolog_ciaolibdir,1);

				/* streams.c */
  
  define_c_mod_predicate("streams_basic","stream_code",prolog_stream_code,2);
  define_c_mod_predicate("internals","$bootversion",prolog_bootversion,0);
  /*define_c_predicate("$source_path_name",prolog_sourcepath,2); */
  define_c_mod_predicate("internals","$open",prolog_open,3);
  define_c_mod_predicate("streams_basic","close",prolog_close,1); 
  define_c_mod_predicate("internals","$unix_popen",prolog_unix_popen,3);
  define_c_mod_predicate("streams_basic","character_count",character_count,2);
  define_c_mod_predicate("streams_basic","line_position",line_position,2);
  define_c_mod_predicate("streams_basic","line_count",line_count,2);
  /* aliases handling */
  define_c_mod_predicate("streams_basic","current_input",prolog_current_input,1);
  define_c_mod_predicate("streams_basic","set_input",prolog_set_input,1);
  define_c_mod_predicate("streams_basic","current_output",prolog_current_output,1);
  define_c_mod_predicate("streams_basic","set_output",prolog_set_output,1);

  define_c_mod_predicate("io_alias_redirection", "replace_stream", prolog_replace_stream,2);
  define_c_mod_predicate("io_alias_redirection", "get_stream", prolog_get_stream,2);

                              /* objareas.c */

  define_c_mod_predicate("internals","$purge",prolog_purge,1);
  define_c_mod_predicate("internals","$erase",prolog_erase,1);
  define_c_mod_predicate("internals","$ptr_ref",prolog_ptr_ref,2);
  define_c_mod_predicate("internals","$inserta",inserta,2);
  define_c_mod_predicate("internals","$insertz",insertz,2);
  define_c_mod_predicate("internals","$make_bytecode_object",make_bytecode_object,4);
/*  define_c_predicate("$context_switch",context_switch,0);*/ 

				/* term_support.c */

  define_c_mod_predicate("atomic_basic","name",prolog_name,2);
  define_c_mod_predicate("atomic_basic","atom_codes",prolog_atom_codes,2);
  define_c_mod_predicate("atomic_basic","number_codes",prolog_number_codes,2);
  define_c_mod_predicate("atomic_basic","atom_length",prolog_atom_length,2);
  define_c_mod_predicate("atomic_basic","sub_atom",prolog_sub_atom,4);
  define_c_mod_predicate("atomic_basic","atom_concat",prolog_atom_concat,3);
  define_c_mod_predicate("term_basic","copy_term",prolog_copy_term,2);

				/* indexing.c */
  define_c_mod_predicate("internals","$abolish",prolog_abolish,1); /* JFMC */
  define_c_mod_predicate("internals","$define_predicate",define_predicate,2);
  define_c_mod_predicate("internals","$erase_clause",erase_clause,1);
  define_c_mod_predicate("internals","$clause_number",clause_number,2);
  define_c_mod_predicate("internals","$compiled_clause",compiled_clause,4);
  define_c_mod_predicate("internals","$empty_gcdef_bin",empty_gcdef_bin,0);
  define_c_mod_predicate("internals","$set_property",set_property,2);
				/* inout.c */
  
  define_c_mod_predicate("io_basic","code_class",code_class,2);
  define_c_mod_predicate("streams_basic","flush_output",flush_output,0);
  define_c_mod_predicate("streams_basic","flush_output",flush_output1,1);
  address_getct = define_c_mod_predicate("io_basic","getct",getct,2);
  address_getct1 = define_c_mod_predicate("io_basic","getct1",getct1,2);
  address_get = define_c_mod_predicate("io_basic","get_code",get,1);
  address_get2 = define_c_mod_predicate("io_basic","get_code",get2,2);
  address_get1 = define_c_mod_predicate("io_basic","get1_code",get1,1);
  address_get12 = define_c_mod_predicate("io_basic","get1_code",get12,2);
  address_peek = define_c_mod_predicate("io_basic","peek_code",peek,1);
  address_peek2 = define_c_mod_predicate("io_basic","peek_code",peek2,2);
  define_c_mod_predicate("io_basic","nl",nl,0);
  define_c_mod_predicate("io_basic","nl",nl1,1);
  define_c_mod_predicate("io_basic","put_code",put,1);
  define_c_mod_predicate("io_basic","put_code",put2,2);
  define_c_mod_predicate("io_basic","tab",tab,1);
  define_c_mod_predicate("io_basic","tab",tab2,2);
  address_skip = define_c_mod_predicate("io_basic","skip_code",skip,1);
  address_skip2 = define_c_mod_predicate("io_basic","skip_code",skip2,2);
  define_c_mod_predicate("io_basic","display",prolog_display,1);
  define_c_mod_predicate("io_basic","display",prolog_display2,2);
  define_c_mod_predicate("io_basic","displayq",prolog_displayq,1);
  define_c_mod_predicate("io_basic","displayq",prolog_displayq2,2);
  define_c_mod_predicate("streams_basic","clearerr",prolog_clearerr,1);
  ...
  define_c_mod_predicate("internals","$ddt",set_predtrace,1);

				/* qread.c */

  define_c_mod_predicate("internals","$qread",prolog_qread,2);
  define_c_mod_predicate("internals","$push_qlinfo",push_qlinfo,0);
  define_c_mod_predicate("internals","$pop_qlinfo",pop_qlinfo,0);

				/* misc.c */
  
  define_c_mod_predicate("prolog_sys", "new_atom", prolog_new_atom, 1);
  define_c_mod_predicate("internals","$set_global_logical_var", set_glv, 2);
  define_c_mod_predicate("internals","$get_global_logical_var", get_glv, 2);
#if defined(ATOMGC)
  define_c_mod_predicate("internals","$erase_atom", prolog_erase_atom, 1);
#endif
  define_c_mod_predicate("system","current_executable", prolog_current_executable,1);
  define_c_mod_predicate("internals","$prompt",prompt,2);
  define_c_mod_predicate("internals","$frozen",frozen,2);
  define_c_mod_predicate("internals","$defrost",defrost,2);
  define_c_mod_predicate("internals","$setarg",setarg,4);
  define_c_mod_predicate("internals","$undo_goal",undo,1);
  define_c_mod_predicate("basiccontrol","$metachoice",metachoice,1);
  define_c_mod_predicate("basiccontrol","$metacut",metacut,1);
  define_c_mod_predicate("debugger","$retry_cut",retry_cut,2);
  define_c_mod_predicate("internals","$unknown",unknown,2);
...
/* define_c_predicate("$breaklevel",breaklevel,2); */
  define_c_mod_predicate("internals","$compiling",compiling,2);
  define_c_mod_predicate("internals","$ferror_flag",ferror_flag,2);
...
/* define_c_predicate("$multiple_flag",redefine_flag,2);*/
  define_c_mod_predicate("internals","$quiet_flag",quiet_flag,2);
  define_c_mod_predicate("debugger","$spypoint",spypoint,3);
  define_c_mod_predicate("debugger","$debugger_state",debugger_state,2);
  define_c_mod_predicate("debugger","$debugger_mode",debugger_mode,0);
  define_c_mod_predicate("internals","$prolog_radix",prolog_radix,2);
  define_c_mod_predicate("internals","$constraint_list",constraint_list,2);
  define_c_mod_predicate("internals","$eq",prolog_eq,2);
  define_c_mod_predicate("internals","$large_data",large_data,3);
  define_c_mod_predicate("internals","$interpreted_clause",prolog_interpreted_clause,2);
#if defined(UNDEFINED)
  ...
  define_c_mod_predicate("internals","$unlock_predicate",prolog_unlock_predicate,1);
  ...
  define_c_mod_predicate("internals","$exec",prolog_exec,4);
  define_c_mod_predicate("internals","$unix_argv",prolog_unix_argv,1);
  ...
  define_c_mod_predicate("system_info","get_arch", prolog_getarch, 1);
  define_c_mod_predicate("system_info","get_os", prolog_getos, 1);
  define_c_mod_predicate("internals","$ciao_version", prolog_version, 2);

  define_c_mod_predicate("internals","$find_file",prolog_find_file,8); 


                            /* dynlink.c */

  define_c_mod_predicate("internals","dynlink", prolog_dynlink, 2);
  define_c_mod_predicate("internals","dynunlink", prolog_dynunlink, 1); /* JFMC */

				/* format.c */
  
  define_c_mod_predicate("internals","$format_print_float",prolog_format_print_float,3);
  define_c_mod_predicate("internals","$format_print_integer",prolog_format_print_integer,3);

				/* timing.c */

  define_c_mod_predicate("internals","$runtime",prolog_runtime,1);
  define_c_mod_predicate("internals","$walltime", prolog_walltime, 1);
  ...
  define_c_mod_predicate("internals","$termheap_usage",termheap_usage,1);
  define_c_mod_predicate("internals","$envstack_usage",envstack_usage,1);
  define_c_mod_predicate("internals","$trail_usage",trail_usage,1);
  define_c_mod_predicate("internals","$choice_usage",choice_usage,1);
  define_c_mod_predicate("internals","$stack_shift_usage",stack_shift_usage,1);

				/* alloc.c */

  define_c_mod_predicate("prolog_sys","statistics",statistics,0);
  define_c_mod_predicate("internals","$program_usage",program_usage,1);
  define_c_mod_predicate("internals","$internal_symbol_usage",internal_symbol_usage,1);
  define_c_mod_predicate("internals","$total_usage",total_usage,1);

                                 /* heapgc.c */

  define_c_mod_predicate("internals","$gc_mode",gc_mode,2);
  define_c_mod_predicate("internals","$gc_trace",gc_trace,2);
  define_c_mod_predicate("internals","$gc_margin",gc_margin,2);
  define_c_mod_predicate("internals","$gc_usage",gc_usage,1);
  define_c_mod_predicate("prolog_sys","garbage_collect",gc_start,0);

				/* nondet.c */
  
  define_c_mod_predicate("basiccontrol","repeat",prolog_repeat,0);
  define_c_mod_predicate("prolog_sys","current_atom",current_atom,1);
  define_c_mod_predicate("streams_basic","current_stream",current_stream,3);
  define_c_mod_predicate("internals","$current_predicate",current_predicate,2);
  define_c_mod_predicate("internals","$predicate_property",predicate_property,3);
  define_c_mod_predicate("internals","$current_clauses",current_clauses,2);

#if defined(OLD_DATABASE)
  define_c_predicate("$current_key",current_key,4);
#endif
  define_c_mod_predicate("internals","$first_instance",first_instance,2);
  define_c_mod_predicate("internals","$close_predicate",close_predicate,1);
  define_c_mod_predicate("internals","$open_predicate",open_predicate,1);

#if defined(GAUGE)
  				/* gauge.c */

  define_c_mod_predicate("internals","$emulated_clause_counters",emulated_clause_counters,4);
  define_c_mod_predicate("internals","$counter_values",counter_values,3);
  define_c_mod_predicate("internals","$reset_counters",reset_counters,2);
#endif
