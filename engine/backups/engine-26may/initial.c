...
*/
  ...
  define_c_mod_predicate("atomic_basic","number_codes",2,prolog_number_codes);
  ...
  define_c_mod_predicate("debugger","$retry_cut",2,retry_cut);
  ...
  define_c_mod_predicate("debugger","$spypoint",3,spypoint);
  define_c_mod_predicate("debugger","$debugger_state",2,debugger_state);
  define_c_mod_predicate("debugger","$debugger_mode",0,debugger_mode);
  ...
  define_c_mod_predicate("system","getenvstr", 2,prolog_getenvstr);
  define_c_mod_predicate("system","setenvstr", 2,prolog_setenvstr);
