...
typedef struct goal_str *ciao_state;
...
ciao_term ciao_float_s(ciao_state state, double i);
...
ciao_term ciao_dlist_a_s(ciao_state state, int len, ciao_term *args, ciao_term base);
...
int ciao_to_integer_s(ciao_state state, ciao_term term); /* PRECONDITION: ciao_is_integer_s(state, term) */
int ciao_to_integer(ciao_term term); /* PRECONDITION: ciao_is_integer(term) */
ciao_bool ciao_is_number_s(ciao_state state, ciao_term term);
ciao_bool ciao_is_number(ciao_term term);
double ciao_to_float_s(ciao_state state, ciao_term term); /* PRECONDITION: ciao_is_number_s(state, term) */
double ciao_to_float(ciao_term term); /* PRECONDITION: ciao_is_number(term) */

ciao_bool ciao_is_atom_s(ciao_state state, ciao_term atom);
ciao_bool ciao_is_atom(ciao_term atom);
const char *ciao_atom_name_s(ciao_state state, ciao_term atom);
const char *ciao_atom_name(ciao_term atom);
char *ciao_atom_name_dup_s(ciao_state state, ciao_term atom);
...
ciao_term ciao_copy_term_s(ciao_state src_desc, ciao_term src_term, ciao_state dst_desc);
ciao_term ciao_copy_term(ciao_term src_term);
ciao_bool ciao_unify_s(ciao_state state, ciao_term x, ciao_term y); /* =/2 */
ciao_bool ciao_unify(ciao_term x, ciao_term y); /* =/2 */
ciao_bool ciao_equal_s(ciao_state state, ciao_term x, ciao_term y); /* ==/2 */
ciao_bool ciao_equal(ciao_term x, ciao_term y); /* ==/2 */
...
char *ciao_list_to_byte_array(ciao_state state, ciao_term list);
int *ciao_list_to_int_array(ciao_state state, ciao_term list);
char *ciao_list_to_str(ciao_state state, ciao_term list);
ciao_term ciao_byte_listn(ciao_state state, const char *s, int length);
ciao_term ciao_int_listn(ciao_state state, int *s, int length);
