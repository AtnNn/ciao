...
:- comment(version(1*9+353,2004/06/29,20:36*10+'CEST'), "Included
   definitions for LINUXarml4v system (Jose Morales)").

:- comment(version(1*9+352,2004/06/29,20:29*34+'CEST'), "Added ieee
   float definitions for armv4l architecture (Edison & Jose Morales)").
