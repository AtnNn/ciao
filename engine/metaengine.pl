...
:- comment(version(1*11+152,2004/01/02,00:33*58+'CET'), "Added
   predicate emit_ins_no_label/2 to avoid warnings about unused labels
   when compiling the ciao engine.  (Edison Mera)").
