...
% Emit a instruction entry (label, case and code)
emit_ins(Ins, Mode) -->
	emit_label(Ins, Mode), ":\n",
...
emit_file(r) -->
	...
	emit_ins(initcallq,Mode),
	emit_ins(initcall,Mode),
	emit_ins(firstcall_nq,Mode),
	emit_ins(firstcall_n,Mode),
	emit_ins(firstcall_8q,Mode),
	emit_ins(firstcall_8,Mode),
	emit_ins(firstcall_7q,Mode),
	emit_ins(firstcall_7,Mode),
	emit_ins(firstcall_6q,Mode),
	emit_ins(firstcall_6,Mode),
	emit_ins(firstcall_5q,Mode),
	emit_ins(firstcall_5,Mode),
	emit_ins(firstcall_4q,Mode),
	emit_ins(firstcall_4,Mode),
	emit_ins(firstcall_3q,Mode),
	emit_ins(firstcall_3,Mode),
	emit_ins(firstcall_2q,Mode),
	emit_ins(firstcall_2,Mode),
	emit_ins(firstcall_1q,Mode),
	emit_ins(firstcall_1,Mode),
	emit_ins(firstcallq,Mode),
	emit_ins(firstcall,Mode),
	emit_ins(call_nq,Mode),
	emit_ins(call_n,Mode),
	emit_ins(call_8q,Mode),
	emit_ins(call_8,Mode),
	emit_ins(call_7q,Mode),
	emit_ins(call_7,Mode),
	emit_ins(call_6q,Mode),
	emit_ins(call_6,Mode),
	emit_ins(call_5q,Mode),
	emit_ins(call_5,Mode),
	emit_ins(call_4q,Mode),
	emit_ins(call_4,Mode),
	emit_ins(call_3q,Mode),
	emit_ins(call_3,Mode),
	emit_ins(call_2q,Mode),
	emit_ins(call_2,Mode),
	emit_ins(call_1q,Mode),
	emit_ins(call_1,Mode),
	emit_ins(callq,Mode),
	emit_ins(call,Mode),
	emit_ins(lastcall_nq,Mode),
	emit_ins(lastcall_n,Mode),
	emit_ins(lastcall_8q,Mode),
	emit_ins(lastcall_8,Mode),
	emit_ins(lastcall_7q,Mode),
	emit_ins(lastcall_7,Mode),
	emit_ins(lastcall_6q,Mode),
	emit_ins(lastcall_6,Mode),
	emit_ins(lastcall_5q,Mode),
	emit_ins(lastcall_5,Mode),
	emit_ins(lastcall_4q,Mode),
	emit_ins(lastcall_4,Mode),
	emit_ins(lastcall_3q,Mode),
	emit_ins(lastcall_3,Mode),
	emit_ins(lastcall_2q,Mode),
	emit_ins(lastcall_2,Mode),
	emit_ins(lastcall_1q,Mode),
	emit_ins(lastcall_1,Mode),
	emit_ins(lastcallq,Mode),
	emit_ins(lastcall,Mode),
	emit_ins(executeq,Mode),
	emit_ins(execute,Mode),
	emit_ins(put_x_void,Mode),
	emit_ins(put_x_variable,Mode),
	emit_ins(put_xval_xval,Mode),
	emit_ins(put_x_value,Mode),
	...
	emit_ins(put_yval_yval,Mode),
	emit_ins(put_y_value,Mode),
	emit_ins(put_y_unsafe_value,Mode),
	emit_ins(put_constantq,Mode),
	emit_ins(put_constant,Mode),
	emit_ins(put_nil,Mode),
	...
	emit_ins(get_constantq,Mode),
	emit_ins(get_constant,Mode),
	emit_ins(get_largeq,Mode),
	emit_ins(get_large,Mode),
	emit_ins(get_structureq,Mode),
	emit_ins(get_structure,Mode),
	emit_ins(get_nil,Mode),
	emit_ins(get_list,Mode),
	emit_ins(get_constant_neck_proceedq,Mode),
	...
	emit_ins(cutf,Mode),
	emit_ins(cut_y,Mode),
	emit_ins(choice_x,Mode),
	emit_ins(choice_yf,Mode),
	...
	emit_ins(get_structure_x0q,Mode),
	emit_ins(get_structure_x0,Mode),
	emit_ins(get_large_x0q,Mode),
	emit_ins(get_large_x0,Mode),
	emit_ins(get_constant_x0q,Mode),
	emit_ins(get_constant_x0,Mode),
	emit_ins(get_nil_x0,Mode),
	emit_ins(get_list_x0,Mode),
	emit_ins(get_xvar_xvar,Mode),
	emit_ins(get_x_variable,Mode),
	emit_ins(get_y_first_variable,Mode),
	emit_ins(get_y_variable,Mode),
	emit_ins(get_yfvar_yvar,Mode),
	emit_ins(get_yvar_yvar,Mode),
	emit_ins(branch,Mode),
